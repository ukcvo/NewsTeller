    ...
    for aggKey in ["0", "1", "2", "3"]:
        for aggSent in ["0", "1", "2", "3"]:
            for title in ["false", "true"]:
                f.write('\t<bean id="textEmbeddingsFeature' + aggKey + aggSent + title[0] + '" class="edu.kit.anthropomatik.isl.newsTeller.retrieval.ranking.features.TextEmbeddingsFeature">\n')
                ...
                f.write('\t\t<property name="name" value="textEmbeddings' + aggKey + aggSent + title[0] + '" />\n')
