                ...
                for contains in ["false", "true"]:
                    for stem in ["false", "true"]:
                        for split in ["false", "true"]:
                            f.write('\t<bean id="keywordInSentenceFeature' + aggKey + aggSent + title[0] + contains[0] + stem[0] + split[0] + userInterests 
                            ...
                            f.write('\t\t<property name="name" value="keywordInSentence' + aggKey + aggSent + title[0] + contains[0] + stem[0] + split[0] + userInterests + '" />\n')
